...
main(int argc, char *argv[])
{
  ...
  1e:	85e58593          	addi	a1,a1,-1954 # 878 <malloc+0xfc>
  22:	4509                	li	a0,2
  24:	00000097          	auipc	ra,0x0
  28:	66c080e7          	jalr	1644(ra) # 690 <fprintf>
        exit(1);
  2c:	4505                	li	a0,1
  ...
  3a:	82a58593          	addi	a1,a1,-2006 # 860 <malloc+0xe4>
  3e:	4509                	li	a0,2
  40:	00000097          	auipc	ra,0x0
  44:	650080e7          	jalr	1616(ra) # 690 <fprintf>
        exit(1);
  48:	4505                	li	a0,1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 42e:	49650513          	addi	a0,a0,1174 # 8c0 <digits>
 432:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4fa:	3cab8b93          	addi	s7,s7,970 # 8c0 <digits>
 ...
 63a:	28290913          	addi	s2,s2,642 # 8b8 <malloc+0x13c>
        while(*s != 0){
...
free(void *ap)
{
 ...
 702:	1da7b783          	ld	a5,474(a5) # 8d8 <freep>
 ...
 730:	00e6ea63          	bltu	a3,a4,744 <free+0x50>
{
 ...
 772:	16f73523          	sd	a5,362(a4) # 8d8 <freep>
}
 776:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7a4:	13853503          	ld	a0,312(a0) # 8d8 <freep>
 ...
 7cc:	11090913          	addi	s2,s2,272 # 8d8 <freep>
  if(p == (char*)-1)
 7d0:	5afd                	li	s5,-1
 7d2:	a88d                	j	844 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 7d4:	00000797          	auipc	a5,0x0
 7d8:	10c78793          	addi	a5,a5,268 # 8e0 <base>
 7dc:	00000717          	auipc	a4,0x0
 7e0:	0ef73e23          	sd	a5,252(a4) # 8d8 <freep>
 7e4:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 806:	0ca73b23          	sd	a0,214(a4) # 8d8 <freep>
      return (void*)(p + 1);
