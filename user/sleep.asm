...
main(int argc, char *argv[])
{
  ...
  14:	1f8080e7          	jalr	504(ra) # 208 <atoi>
    if (time == 0) {
  18:	ed0d                	bnez	a0,52 <main+0x52>
        fprintf(2, "Usage: sleep TIME\nTIME should be an integer larger than 0.\n");
  1a:	00001597          	auipc	a1,0x1
  1e:	8f658593          	addi	a1,a1,-1802 # 910 <malloc+0xfc>
  22:	4509                	li	a0,2
  24:	00000097          	auipc	ra,0x0
  28:	684080e7          	jalr	1668(ra) # 6a8 <fprintf>
        exit(1);
  2c:	4505                	li	a0,1
  2e:	00000097          	auipc	ra,0x0
  32:	2f0080e7          	jalr	752(ra) # 31e <exit>
        fprintf(2, "Usage: sleep TIME\n");
  36:	00001597          	auipc	a1,0x1
  3a:	8c258593          	addi	a1,a1,-1854 # 8f8 <malloc+0xe4>
  3e:	4509                	li	a0,2
  40:	00000097          	auipc	ra,0x0
  44:	668080e7          	jalr	1640(ra) # 6a8 <fprintf>
        exit(1);
  48:	4505                	li	a0,1
  4a:	00000097          	auipc	ra,0x0
  4e:	2d4080e7          	jalr	724(ra) # 31e <exit>
    }
    sleep(time);
  52:	00000097          	auipc	ra,0x0
  56:	344080e7          	jalr	836(ra) # 396 <sleep>
    exit(0);
  5a:	4501                	li	a0,0
...
putc(int fd, char c)
{
 ...
 400:	57478793          	addi	a5,a5,1396 # 970 <len>
 404:	4398                	lw	a4,0(a5)
 406:	0017069b          	addiw	a3,a4,1
 40a:	c394                	sw	a3,0(a5)
 40c:	00000797          	auipc	a5,0x0
 410:	57478793          	addi	a5,a5,1396 # 980 <printbuf>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 446:	51650513          	addi	a0,a0,1302 # 958 <digits>
 44a:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 512:	44ab8b93          	addi	s7,s7,1098 # 958 <digits>
 ...
 652:	30290913          	addi	s2,s2,770 # 950 <malloc+0x13c>
        while(*s != 0){
...
fprintf(int fd, const char *fmt, ...)
{
 ...
 6de:	29690913          	addi	s2,s2,662 # 970 <len>
 6e2:	00092603          	lw	a2,0(s2)
 6e6:	00000597          	auipc	a1,0x0
 6ea:	29a58593          	addi	a1,a1,666 # 980 <printbuf>
 6ee:	8526                	mv	a0,s1
 ...
 70c:	27850513          	addi	a0,a0,632 # 980 <printbuf>
 710:	00000497          	auipc	s1,0x0
 714:	26048493          	addi	s1,s1,608 # 970 <len>
 718:	409c                	lw	a5,0(s1)
...
printf(const char *fmt, ...)
{
 ...
 762:	22250513          	addi	a0,a0,546 # 980 <printbuf>
 766:	00000497          	auipc	s1,0x0
 76a:	20a48493          	addi	s1,s1,522 # 970 <len>
 76e:	409c                	lw	a5,0(s1)
...
free(void *ap)
{
 ...
 79a:	1e27b783          	ld	a5,482(a5) # 978 <freep>
 ...
 7c8:	00e6ea63          	bltu	a3,a4,7dc <free+0x50>
{
 ...
 80a:	16f73923          	sd	a5,370(a4) # 978 <freep>
}
 80e:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 83c:	14053503          	ld	a0,320(a0) # 978 <freep>
 ...
 864:	11890913          	addi	s2,s2,280 # 978 <freep>
  if(p == (char*)-1)
 868:	5afd                	li	s5,-1
 86a:	a88d                	j	8dc <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 86c:	00000797          	auipc	a5,0x0
 870:	17c78793          	addi	a5,a5,380 # 9e8 <base>
 874:	00000717          	auipc	a4,0x0
 878:	10f73223          	sd	a5,260(a4) # 978 <freep>
 87c:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 89e:	0ca73f23          	sd	a0,222(a4) # 978 <freep>
      return (void*)(p + 1);
