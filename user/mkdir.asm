...
main(int argc, char *argv[])
{
  ...
  42:	83a58593          	addi	a1,a1,-1990 # 878 <malloc+0xe8>
  46:	4509                	li	a0,2
  48:	00000097          	auipc	ra,0x0
  4c:	65c080e7          	jalr	1628(ra) # 6a4 <fprintf>
    exit(1);
  50:	4505                	li	a0,1
  ...
  60:	83458593          	addi	a1,a1,-1996 # 890 <malloc+0x100>
  64:	4509                	li	a0,2
  66:	00000097          	auipc	ra,0x0
  6a:	63e080e7          	jalr	1598(ra) # 6a4 <fprintf>
      break;
    }
  }
...
malloc(uint nbytes)
{
 ...
 868:	b3e080e7          	jalr	-1218(ra) # 3a2 <sbrk>
  if(p == (char*)-1)
